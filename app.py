...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Precise time tracking from contact creation to conversion</p>
        </div>
    ...
    <script>
        ...
        function updateBestTimesTable() {
            ...
            bestTimes.slice(0, 10).forEach(item => {
                const row = document.createElement('tr');
        ...
        async function syncLocations() {
            ...
            try {
                ...
                if (result.status === 'success') {
                    ...
                    loadLocations();  // Reload location dropdown
                } else {
...
def webhook_handler():
    """Enhanced webhook handler for real-time contact tracking"""
    try:
...
if __name__ == '__main__':
    ...
    print(f"⚡ Features: Real-time tracking, Accurate calculations, Live webhooks")
    
    app.run(host='0.0.0.0', port=port, debug=False)# app.py - Enhanced GHL System with Real Data Sync and Accurate Calculations
...
SCOPES = [
    ...
    "locations/tags.readonly", "opportunities.readonly", "appointments.readonly"
]
...
class RealTimeLeadAnalytics:
    ...
    def init_database(self):
        ...
        cursor.execute('''
            CREATE TABLE IF NOT EXISTS contact_journey (
                ...
                -- Status tracking
                current_status TEXT DEFAULT 'new_lead',  -- new_lead, contacted, connected, session_booked, purchased, lost
    ...
    def record_contact_created(self, contact_data, location_id):
        """Record when a contact is created with accurate timestamp"""
    ...
    <body>
        <div class="card">
            ...
            <div class="features">
                ...
                <ul>
                    <li>⏱️ <strong>Contact Created</strong> → First Call: Minutes/Hours</li>
                    ...
                    <li>🎯 Current opportunity stages and lead status</li>
                    <li>📈 Best performing call times by actual data</li>
                </ul>
